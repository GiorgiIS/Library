...
namespace ProjectManagementTool
{
    public class SearchQueryFactory
    {
        ...
        public SearchQueryFactory(string projectPath, Type entity)
        {
            ...
            _searchQueryFolderPath = $@"{_projectPath}\Library.Common.Api\RequestModels";
        }
        ...
        public void CreateSearchQuery()
        {
            ...
            var properties = PropertyHelper.TransforPropertysToNullableStatements(propsWithoutDateTimes);
