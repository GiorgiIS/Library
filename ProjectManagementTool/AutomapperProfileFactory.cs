...
namespace ProjectManagementTool
{
    public class AutomapperProfileFactory
    {
        ...
        {
            var automapperProfile = FileHelper.GetFile($@"{_projectPath}\Library.Services", "AutomapperProfile.cs");
            ...
            var additionalUsingStatement = $"\nusing Library.Services.Dtos.{_entity.Name}Dtos;";
            ...
            var mapperProfilerFullPath = $@"{_projectPath}\Library.Services\AutomapperProfile.cs";
